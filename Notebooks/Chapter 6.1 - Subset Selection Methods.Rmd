---
title: "Chapter 6.1 - Subset Selection Methods"
...
in the backward selection output, CRuns is the best variable in the single model, and CRuns/hits are the best variables for model with two vars
...
We saw that the ten-variable model performed best, so let's rerun the regsubsets() using the testing data and select the 
ten-variable model
